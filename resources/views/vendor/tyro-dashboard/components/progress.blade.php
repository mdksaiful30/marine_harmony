...
<div {{ $attributes->merge(['class' => 'progress-wrapper']) }}>
    ...
    @endif
    <div class="progress-track" role="progressbar" aria-valuenow="{{ $value }}" aria-valuemin="0" aria-valuemax="100"@if($hasLabel) aria-label="{{ $label }}"@endif style="height: {{ $trackHeight }};">
