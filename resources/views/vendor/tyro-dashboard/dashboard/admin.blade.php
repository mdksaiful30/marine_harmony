...
<div class="stats-grid">
    ...
    <a href="{{ route($dashboardRoute::name('invitations.admin.index')) }}" class="stat-card" style="text-decoration: none; color: inherit; display: block;">
        <div class="stat-icon stat-icon-info">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <a href="{{ route($dashboardRoute::name('users.index'), ['search' => '', 'role' => '', 'status' => 'logged_in']) }}" class="stat-card" style="text-decoration: none; color: inherit; display: block;">
        <div class="stat-icon stat-icon-success">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="stat-content">
            <div class="stat-label" style="font-size: 0.9375rem;">Total Loggedin Users</div>
            <div class="stat-value">{{ number_format($stats['total_logged_in_users'] ?? 0) }}</div>
        </div>
    </a>
</div>
